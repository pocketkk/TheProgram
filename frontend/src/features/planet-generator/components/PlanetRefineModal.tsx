/**
 * PlanetRefineModal Component - Modal for refining individual planet images
 *
 * Features:
...
import type { Planet } from '../constants/planets'
import { PLANET_CATEGORIES } from '../constants/planets'

interface PlanetRefineModalProps {
  isOpen: boolean
  onClose: () => void
  planet: Planet
  image: ImageInfo
...
export function PlanetRefineModal({
  isOpen,
  onClose,
  planet,
  image,
  onRefineComplete,
}: PlanetRefineModalProps) {
  ...
  const handleRefine = async () => {
    ...
    console.log('Refine clicked:', { useEditedPrompt, effectiveRefinement, imageId: image.id })
    ...
    try {
      console.log('Calling refineImage API...')
      ...
      if (response.success && response.image_url) {
        ...
        // The set will refresh when modal closes via handleClose
      } else {
        console.error('Refine failed:', response)
        ...
        <div className="p-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="w-48 h-48 rounded-lg overflow-hidden border border-gray-700">
                <img
                  src={image.url}
                  alt={planet.name}
              ...
              <div className="mt-2 text-sm text-gray-400">
                {PLANET_CATEGORIES[planet.category]}
              </div>
            </div>
            ...
            <div className="flex-1 space-y-4">
                    ...
                    <div>
                      ...
                      {isPromptModified && (
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          />
                          <label htmlFor="useEditedPrompt" className="text-xs text-gray-400">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={useEditedPrompt
                    ...
                    : "e.g., Add more cosmic energy, make colors more vibrant, add glowing aura, make it more mystical..."
                  }
                  rows={3}
              ...
              {previewImage && (
                <div>
                  ...
                  <div className="w-48 h-48 rounded-lg overflow-hidden border border-celestial-purple">
                    <img
                      src={previewImage}
                      alt={`Refined ${planet.name}`}
                      className="w-full h-full object-cover"
                    />
                  </div>
                </div>
            ...
            >
              {isRefining ? (
                ...
                <>
                  ...
                  {previewImage ? 'Refine Again' : useEditedPrompt ? 'Regenerate' : 'Refine Planet'}
                </>
              )}
            </Button>
          </div>
